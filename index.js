...
const details = [
    {
        ...
        "imgSrc": "./assets/colorful_painting_of_joker_joaquin_phoenix_4k_hd_joker-3840x2160.jpg"
    },
    {
        "author": "Kaneki Ken",
        "addedAt": new Date().toLocaleString(),
...
details.forEach((detail) => {
    ...
    readButton.addEventListener('click', () => {
        ...
        detail.views += detail.isRead ? 1 : -1;
